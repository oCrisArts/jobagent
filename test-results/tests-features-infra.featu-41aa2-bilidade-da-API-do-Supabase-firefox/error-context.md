...
- Name: tests\features\infra.feature.spec.js >> Validação de Infraestrutura >> Validar disponibilidade da API do Supabase
- Location: .features-gen\tests\features\infra.feature.spec.js:40:3
