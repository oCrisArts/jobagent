...
- Name: tests\features\infra.feature.spec.js >> Validação de Infraestrutura >> Validar conexão com banco de dados Supabase
- Location: .features-gen\tests\features\infra.feature.spec.js:33:3
