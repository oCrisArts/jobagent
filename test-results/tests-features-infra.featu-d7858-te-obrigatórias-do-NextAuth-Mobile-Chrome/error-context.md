...
- Name: tests\features\infra.feature.spec.js >> Validação de Infraestrutura >> Validar variáveis de ambiente obrigatórias do NextAuth
- Location: .features-gen\tests\features\infra.feature.spec.js:26:3
